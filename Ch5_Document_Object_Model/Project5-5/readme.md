### Create and Reference Document Elements
* Declare variables
* Create a for statement
* Set the the content of the element with an id value to the current value of the counter
* Create a new li element and assign the value
* Add a backward-compatible event listener when the page finishes loading.

![Chapter5_5](../Project5-5/images/project5-5.png)
...
<body>
   ...
   <script>
      //1. declare variable that contains a reference to the ul element in the doc.
      var list = document.querySelector("ul");
      var headingText = "";
      var TOCEntry = "";
      /*2. create a for loop
         - set value of the headingText variable to the content of the element with an
           id value equal to the current value of the counter variable.
         - Create a new li element, and assign it as the value of the TOCEntry variable.
         - Set the content of the TOCEntry node to the following.
         - Add the  TOCEntry node as the last child of the list node.
      */
         function createTOC() {
            for (var i = 1; i <= 10; i++) {
               headingText = document.getElementById(i);
               TOCEntry = document.createElement("li");
               TOCEntry.innerHTML = "<a href =#" + i + ">" + headingText.innerHTML + "</a>";
               list.appendChild(TOCEntry);
            }
         }
      //add a backward-compatible event listener that calls the createTOC() function
